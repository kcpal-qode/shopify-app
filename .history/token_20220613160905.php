...
if(hash_equals($hmac, $new_hmac)){
  ...
  $query = "INSERT INTO shops (shop_url, access_token, hmac, install_date) VALUES ('". $shop_url."', '" . $response['access_token'] . "', '" . $response['hmac'] . "', NOW()) ON DUPLICATE KEY UPDATE access_token='". $response['access_token']."', hmac='". $response['hmac'] ."'";
