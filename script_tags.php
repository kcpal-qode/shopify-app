...
$script_url = 'https://1da9-202-79-34-246.ngrok.io/elana/scripts/elana.js';
  ...
  scriptTagCreate(input: {
    ...
    userErrors {
      ...
      message
        ...
        //     )
        // );
        // $create_script = $shopify->rest_api('/admin/api/2021-04/script_tags.json', $script_data, 'POST');
    ...
    if ($_POST['action_type'] == 'delete_script') {
        ...
        foreach ($get_script['script_tags'] as $script) {
            $delete_script = $shopify->rest_api('/admin/api/2022-04/script_tags/' . $script['id'] . '.json', array(), "DELETE");
        }
    }
}
...
<section>
    <aside>
        ...
        <p>Click the delete button to remove the script to your Shopify store</p>
    </aside>
    <article>
        <div class="card">
            <form action="" method="post">
