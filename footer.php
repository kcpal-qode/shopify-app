...
<script>
    ...
    var app = createApp({
        apiKey: 'c34e6f7a44f1b087c43f3d784ee5fe66',
    ...
    var installScriptBtn = Button.create(app, {
        label: 'Install Script Tag'
    });
    installScriptBtn.subscribe(Button.Action.CLICK, data => {
        exampleModal.dispatch(Modal.Action.OPEN);
        //redirect.dispatch(Redirect.Action.APP, '/elana/script_tags.php');
    });
    ...
    var getSessionToken = AppBridgeUtil.getSessionToken;
